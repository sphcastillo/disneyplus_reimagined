    ...
    <header className="fixed flex items-center justify-between p-3 top-0 z-50 w-full bg-gradient-to-b from-[#14143C] to-[#141450]">
      <div className="flex items-center space-x-1 md:space-x-7">
        ...
        <div className="relative group flex items-center text-white sm:hidden">
          ...
          <div className="absolute -left-5 mt-32 w-32 bg-gradient-to-b from-[#14143C] to-[#142878] text-white border-2 border-white rounded-xl shadow-lg opacity-0 scale-95 transform transition-all duration-200 group-hover:opacity-100 group-hover:scale-100">
