          ...
          <Card maxW="md" bgGradient='linear(to-r, #140647, #200461)'>
            <CardBody>
              ...
              <Stack mt="6" spacing="3">
                <Heading size="md" color='brand.100'>{series.original_name}</Heading>
            ...
            <CardFooter>
              <ButtonGroup spacing="2">
                <Button color="brand.100" bgGradient='linear(to-b, #B5B7BB, #CCCCCC)' _hover={{ background: "blue", color: "white"}}>
                  Watch Now
                </Button>
                <Button color="brand.100" bgGradient='linear(to-r, #FFCC00, #200461)' _hover={{ background: "blue", color: "white"}}>
                  Trailer
                </Button>
              </ButtonGroup>
            </CardFooter>
