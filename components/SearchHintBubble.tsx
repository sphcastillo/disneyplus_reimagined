...
function SearchHintBubble() {
  ...
  return (
    <div className='absolute top-16 mobile:top-[72px] xs:top-[76px] right-1 mx-2 z-50'>
        <div className="w-32 xxs500:w-36 xs:w-48 md:w-48 bounce-hint-delay-1 bg-blue-100 border border-blue-300 text-blue-800 text-[11px] rounded-lg pl-3 pr-1 py-2 shadow-md">
