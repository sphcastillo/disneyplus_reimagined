import disneyplusicon from "@/images/disneyPluslogo.png";
...
const navigation = {
    solutions: [
      { name: 'Disney+ Partner Program', href: '#' },
      { name: 'Gift Disney+', href: '#' },
    ...
    support: [
      ...
      { name: 'Help', href: '#' },
      { name: 'Closed Captions', href: '#' },
      { name: 'Tv Parental Guidelines', href: '#' },
    ],
    company: [
      { name: 'About Us', href: '#' },
      { name: 'Sitemap', href: '#' },
      { name: 'Jobs', href: '#' },
      { name: 'Holiday Giveaways', href: '#' },
    ],
    legal: [
      { name: "Children's Online Private Policy", href: '#' },
      { name: 'Subscriber Agreement', href: '#' },
      { name: 'Privacy', href: '#' },
      { name: 'US State Prviacy Rights Notice', href: '#' },
    ],
    social: [
      {
        name: 'Facebook',
      ...
      },
      {
        ...
        href: '#',
        icon: (props: any) => (
            <FaTiktok className="h-[22px] w-[22px]"/>
        ),
      },
      {
        name: 'YouTube',
